...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="login"><span id="logo-shine"></span> SHINE</a>
        </div>
        <div class="navbar-collapse collapse navbar-right">
            <ul class="nav navbar-nav">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" class="active"><span class="glyphicon glyphicon-user"></span> Register</a>
                        <ul class="dropdown-menu dropdown-lr animated flipInX" role="menu" style="width: 300px">
                            <div class="col-lg-12">
                                <div class="text-center"><h3 class="text-white"><b>Register</b></h3></div>
                            </div>
                        </ul>
                    </li>
                    <li class="dropdown">
...
<div id="service">
    <div class="container">
        <div class="col-md-5 col-md-offset-3" style="margin-bottom: 60px">
            <form:form method="POST" modelAttribute="userForm" class="form-signin">
                ...
                <spring:bind path="password">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        <form:input type="password" path="password" class="form-control" placeholder="Password minimum 8 character"></form:input>
