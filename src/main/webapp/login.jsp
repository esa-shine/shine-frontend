    ...
    <div class="container">
        <div class="row centered">
            <div class="col" style="margin: 10px 10px 60px 10px">
                ...
                <h3>Clicking the button on the navigation bar for register or login yourself.</h3>
            </div>
            <div class="col-md-6">
    ...
    <div id="cwrap">
        <div class="container">
            <div class="row centered">
                ...
                <div class="col-md-4">
                    <a target="_blank" href="https://www.esa.int/ESA"><img src="img/contributors/ESA.png" class="img-responsive" style="width:320px; height:auto; display:block; margin-left:auto; margin-right:auto"></a>
                </div>
                <div class="col-md-4">
                </div>
            </div>
